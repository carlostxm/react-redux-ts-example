...
test("API DTO should be mapped to number if API returns data successfully", async () => {
...
test("should return a rejected promise in case of the request fails", async () => {
